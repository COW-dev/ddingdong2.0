  ...
  render: (args) => {
    ...
    return (
      <div className="flex flex-col items-center gap-4">
        <button className="rounded-md bg-primary-300 px-4 py-2 text-white" onClick={openModal}>
          모달 열기
        </button>
        ...
        <Modal isOpen={isOpen} closeModal={closeModal} mode="wait">
          <div className="flex flex-col items-center gap-4 rounded-lg bg-white p-6 shadow-sm">
            ...
            <button onClick={closeModal} className="rounded-lg bg-red-200 px-4 py-2 text-white">
              모달 닫기
            </button>
          </div>
        </Modal>
